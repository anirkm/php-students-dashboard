    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-col sm:flex-row justify-between items-center gap-6 mb-8">
            <div class="flex items-center space-x-4">
                <h1 class="text-3xl font-semibold text-gray-900">Liste des Modules</h1>
        ...
        <div class="backdrop-blur-xl bg-white/50 rounded-2xl shadow-sm p-6 mb-8">
            <form method="GET" class="flex flex-col sm:flex-row items-stretch gap-4">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-3">
                                        <a href="?action=view&element=modules&id=<?= $module[
                                            "rowid"
                                        ] ?>"
                                           class="text-yellow-500 hover:text-yellow-600 transition-colors duration-200">
                                           <i class="fas fa-info"></i>
                                        </a>
                                        <a href="?action=edit&element=modules&id=<?= $module[
                                            "rowid"
                                        ] ?>"
                                           class="text-yellow-500 hover:text-yellow-600 transition-colors duration-200">
                                           <i class="fas fa-edit"></i>
                                        </a>
                                        <button onclick="confirmDelete(<?= $module[
                                            "rowid"
                                        ] ?>)"
